...
public class Scim2SlackGroupInvocator implements DriverInvocator<Scim2Driver, Scim2SlackGroup> {
    ...
    @Override
    public void update(Scim2Driver driver, String userId, Scim2SlackGroup userModel) throws ConnectorException {
    ...
    @Override
    public Scim2SlackGroup getOne(Scim2Driver driver, String objectId, Map<String, Object> prefetchDataMap) throws ConnectorException {
        return null;
    }
}
