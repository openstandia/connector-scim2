<table style="border: 1px black;">
	...
	<tbody style="vertical-align: top">
		...
		<tr>
			...
			<td>boolean</td>
			<td>false</td>
			<td>A Boolean value indicating the 'primary' or preferred attribute value for this attribute, e.g., the preferred mailing address or primary email address.  The primary attribute value 'true' MUST appear no more than once.</td>
			<td>false</td>
			<td></td>
			<td>readWrite</td>
			<td>default</td>
